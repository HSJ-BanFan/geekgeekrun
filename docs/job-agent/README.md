# GeekGeekRun Job Agent for Windows

The Job Agent is a separate Windows x64 product for an Agent Operator. It is not the desktop app and does not require a repository checkout, Node, Python, pnpm, pip, or `PYTHONPATH`.
